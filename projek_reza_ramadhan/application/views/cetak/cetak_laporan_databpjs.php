...
<table class="tabel1">
	...
	<br>
	<center><span style="font-size: 20px"><b>Laporan Data Pemeriksaan Pasien BPJS</b></span></p>
	<center><span style="font-size: 20px"><b>Nama Dokter : <?= $dokter ?></b></span></p>
	...
	<table border="1" class="tabel1">
		<thead>
            ...
            <th align="center">Tanggal Layanan</th>
			<th align="center">Jenis Pasien</th>
        ...
        foreach($datafilter as $key => $data) { ?>
                                            ...
                                            <td align="center" height="16">  <?=$data->kodepasien?></td>
                                            <td align="center" height="16">  <?=$data->nama_pasien?></td>
                                            <td align="center" height="16">  <?=indo_date($data->tgl_layanan)?></td>
                                            <td align="center" height="16">  <?=$data->jenis_pasien?></td>
                                            <td align="center" height="16">  <?=$data->no_bpjs?></td>
                                            <td align="center" height="16">  Rp. <?=number_format($data->harga_layanan + $data->total) ?></td>

...
<table class="tabel1">
	...
	<br>
	<center><span style="font-size: 20px"><b>Laporan Data Pasien</b></span></p>
        ...
        foreach($datafilter as $key => $data) { ?>
											...
											<td align="center" height="16">  <?=$data->kodepasien?></td>
                                                <td align="center" height="16">  <?=$data->nama_pasien?></td>
												 ...
												 <td align="center" height="16">  <?=$data->jenis_kelamin?></td>
												 <td align="center" height="16">  <?=$data->tempat_lahir?></td>
                                                 <td align="center" height="16">  <?=$data->tanggal_lahir?></td>
                                                 <td align="center" height="16">  <?=$data->alamat?></td>
